              ...
              <div className="timeline">
                    ...
                    <div className="d-flex">
                      ...
                      <div className="flex-grow-1 ms-3">
                        ...
                        <p className="text-muted mb-2">
                          ...
                          good luck new job card to go with the words, and pop a
                          beautiful bunch of flowers from our gift range in your
                          basket, to make them feel super special.
                        </p>
                ...
                <div className="timeline-item right">
                  ...
                  <div className="content">
                    ...
                    <p className="text-muted mb-2">
                      It is important for us that we receive email notifications
                      when a ticket is created as our IT staff are mobile and
                      will not always be looking at the dashboard for new
                      tickets.
                    </p>
                    <a
                      href="javascript:void(0);"
                    ...
                    <div className="col-12">
                      <div className="timeline-box">
                        <div className="timeline-text">
                          <h5>Trip planning</h5>
                          <p className="text-muted">
                            In the trip planner, keep only one or two activities
                            in a day if the purpose of the trip is to relax and
                            take it easy during the vacation :
                          </p>
                          <div className="row border border-dashed rounded gx-2 p-2">
                            <div className="col-3">
                      ...
                      <div className="timeline-box">
                        <div className="timeline-text">
                          ...
                          <p className="text-muted mb-0">
                            ...
                            describe the significance of your findings in light
                            of what was already known about the research problem
                      ...
                      <div className="timeline-box">
                        <div className="timeline-text">
                          ...
                          <p className="text-muted mb-0">
                            ...
                            understand their needs and how you can help support
                            them.
                          </p>
                        </div>
                      </div>
          ...
          <div className="col-lg-12">
            <div>
              ...
              <div className="horizontal-timeline my-3">
                <div className="swiper timelineSlider">
