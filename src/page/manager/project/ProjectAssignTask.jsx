...
const ProjectAssignTask = () => {
  ...
  const [annotators, setAnnotators] = useStaimport React, { useState, useEffect } from "react";
import { useParams, useNavigate } from "react-router-dom";
import projectService from "../../../services/manager/project/projectService";
import { userService } from "../../../services/manager/project/userService";
import taskService from "../../../services/manager/project/taskService";
...
const ProjectAssignTask = () => {
  ...
  const assignedItems = projectInfo?.members?.reduce(
    (sum, m) => sum + (m.tasksAssigned || 0),
    0,
  ) ?? 0;
              ...
              <div className="card-body">
                <div className="row mb-3">
                  ...
                  <div className="col-md-3">
                    ...
                    <h5 className={availableItems > 0 ? "text-success" : "text-danger"}>{availableItems}</h5>
                  </div>
                </div>
                ...
                {availableItems === 0 && totalItems > 0 && (
                  <div className="alert alert-warning py-2 small mb-3">
                    ...
                    Tất cả ảnh đã được phân công hoặc duyệt. Dữ liệu đã duyệt (Approved) không thể giao lại.
                  </div>
                )}
            ...
            <div className="card shadow-sm">
              <div className="card-body">
                ...
                <div className="alert alert-light border py-2 small mb-3">
                  ...
                  Cùng 1 ảnh có thể giao cho nhiều Annotator để đối chiếu chất lượng.
                </div>
