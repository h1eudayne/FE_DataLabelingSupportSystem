    ...
    return (
      <div className="stitch-ws-card" style={{ marginTop: 16 }}>
        ...
        <div className="stitch-ws-card-body text-center" style={{ padding: "20px 14px" }}>
          <i className="ri-chat-history-line d-block" style={{ fontSize: 24, opacity: 0.3, marginBottom: 8 }}></i>
          <span className="stitch-ws-text-muted">Chưa có phản hồi nào cho ảnh này.</span>
        </div>
      </div>
    );
  }
    ...
    <div className="stitch-ws-card" style={{ marginTop: 16 }}>
      ...
      <div className="stitch-ws-card-body">
        <div className="d-flex gap-3">
          <div className="stitch-ws-comment-avatar">
            R
          </div>
          <div className="flex-grow-1">
            ...
            <div className="stitch-ws-comment-body">
              {rejectionReason}
            </div>
          </div>
        </div>
