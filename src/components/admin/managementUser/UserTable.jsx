                    ...
                    <tbody>
                        {users.map((user) => (
                            <tr key={user.id}>
                                ...
                                <td>
                                    {/* Chỉ hiển thị số lượng để Admin nắm tổng quan */}
                                    {user.role === "Manager"
                                ...
                                <td>
                                    {
                                        ...
                                        <>
                                            <button className="btn btn-sm btn-soft-primary me-2" onClick={() => onEdit(user)}>
                                                <i className="ri-edit-line"></i>
                                            </button>
                                            <button className="btn btn-sm btn-soft-danger" onClick={() => onDelete(user.id)}>
