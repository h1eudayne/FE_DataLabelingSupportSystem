...
describe("LandingNavbar Component", () => {
  ...
  it("nên hiển thị nút Đăng nhập", () => {
    ...
    const loginBtn = screen.getByRole("button", { name: "landing.login" });
  ...
  it("nên hiển thị nút Bắt đầu ngay", () => {
    ...
    const startBtn = screen.getByRole("button", { name: "landing.getStarted" });
  ...
  it("nên gọi onLogin khi click Bắt đầu ngay", () => {
    ...
    fireEvent.click(screen.getByRole("button", { name: "landing.getStarted" }));
