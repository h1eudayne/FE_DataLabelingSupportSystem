...
const projectService = {
  ...
  getReviewQueueGroupedByAnnotator: (projectId) =>
    axios.get(`/api/reviews/projects/${projectId}/queue`),

  getBatchCompletionStatus: (projectId) =>
    axios.get(`/api/reviews/projects/${projectId}/batch-status`),
};
